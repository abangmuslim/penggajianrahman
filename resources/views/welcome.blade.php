...
<div class="container-fluid">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box shadow-none">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$gaji2}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <div class="info-box shadow-sm">
                ...
                <div class="info-box-content">
                    ...
                    <span class="info-box-number">{{$gaji}}</span>
                </div>
                <!-- /.info-box-content -->
            </div>
            <!-- /.info-box -->
    ...
    <div class="container-fluid p-0">
        <h1 class="h3 mb-1 mt-3">
            <strong>Penggajian</strong> Tercatat
        </h1>
        <div class="row">
            <div class="col-md-3 col-sm-6 col-12">
                <div class="card">
        ...
        <!-- =========================================================== -->
        <h1 class="h3 mb-1 mt-3">
            <strong>Penggajian</strong> Terakhir
        </h1>
        <div class="card-body">
            <table id="example1" class="table table-bordered table-striped ">
                <thead>
                    <tr>
                        <th>No</th>
                        <th>Nama Pegawai</th>
                        <th>TotalPenggajian</th>
                        
                    </tr>
                </thead>
                <tbody>

                    @foreach($datapenggajian as $dt)
                    <tr>
                        <td>{{ $loop->iteration }}</td>
                        <td>{{ $dt->pegawai->name }}</td>
                        <td>{{ $dt->total }}</td>
